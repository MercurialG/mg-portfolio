...
export default function WorkExperience({ experiences }: Props) {
  return (
    <motion.div
      ...
      max-w-full text-left px-10 md:flex-row mx-auto items-center justify-evenly"
    >
      <h3 className="absolute uppercase top-20 tracking-[20px] text-gray-500 text-2xl">
        Experience
      </h3>
      <div
        className="w-full mt-32 flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar
